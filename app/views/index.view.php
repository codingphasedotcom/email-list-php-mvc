        ...
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="w-full px-4">
            ...
            >
              ...
              <form action="/" method="POST" class="mb-2 flex flex-wrap items-center justify-center">
                <ul class=" flex flex-wrap items-center justify-center">
                  ...
                  <li>
                    <button
                      type="submit"
                      class="inline-flex items-center justify-center rounded-lg mr-2 bg-black py-4 px-6 text-center text-base font-medium text-white transition duration-300 ease-in-out hover:text-primary hover:shadow-lg sm:px-10"
                    >
                      Get Started
                      <span class="pl-2">
                        <svg
